...
extern kal_uint16 ov5670MIPI_read_cmos_sensor_sunwin(kal_uint32 addr);
extern void ov5670MIPI_write_cmos_sensor_sunwin(kal_uint32 addr, kal_uint32 para);
...
#define ov5670_write_cmos_sensor(addr,para) ov5670MIPI_write_cmos_sensor_sunwin(addr,para)
#define ov5670_read_cmos_sensor(addr) ov5670MIPI_read_cmos_sensor_sunwin(addr)
...
signed char check_sunwin_MID_ov5670(bool bOnlyCheck);
...
*******************************************************************************/	
bool otp_update_wb_sunwin_ov5670(unsigned short golden_rg, unsigned short golden_bg) 
{
